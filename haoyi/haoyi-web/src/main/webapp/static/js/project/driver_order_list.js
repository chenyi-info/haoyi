$(function(){
		...
		$("#dataGrid").datagrid({
            ...
            onLoadSuccess:function(data){
	         	...
	         	$('.main-dataTable-content input[name=id]:checked').each(function(i,v){
	         		$(v).attr('add','add'); 
	         		var price = $(v).parents('tr').find('td[field=driverPrice]').text();
	         	...
	         	$.each(rows,function(i,v){
	         		total += (v.driverPrice + v.otherAmt - v.settlePrice);
	         	...
	         	$('.dataTable-toolbar .selTotalAmt').html(total + (row.driverPrice + row.otherAmt - row.settlePrice));
	...
	var downExcel = function(){
		...
		buildExportFormSubmit("/driverOrder/loadExcel.do", dataModel);
	}
