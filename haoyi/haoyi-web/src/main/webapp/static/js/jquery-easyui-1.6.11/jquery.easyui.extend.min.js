...
$.map([ 'validatebox', 'textbox', 'passwordbox', 'filebox', 'searchbox', 'combo', 'combobox', 'combogrid', 'combotree', 'datebox',
	'datetimebox', 'numberbox', 'spinner', 'numberspinner', 'timespinner', 'datetimespinner' ],
	function ( plugin ) {
	    if ($.fn[plugin]) {
...
$(function () {
    ...
    /* 分页 */
    // var layout =
    // ["manual","list","first","prev","links","next","last","refresh"];
...
$.extend($.fn.validatebox.defaults.rules, {
	...
	validator : function ( value ) {
	    ...
	    return /^[0-9a-zA-Z]{6,15}$/i.test(value) && !/^([0-9a-zA-Z])\1{5}$/.test(value)
		    && $.inArray(value, pwd) < 0;
	    // /^(.)\1+$/
	},
 ...
 * 
 * @millisecond: 豪秒
 * @format：格式化字符 用法示意：dateFormat(1433232328000,"yyyy-MM-dd HH:mm:ss")
 */
